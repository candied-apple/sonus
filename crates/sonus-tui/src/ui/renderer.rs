...
use super::{layout, header, sidebar, tracklist, queue, lyrics, help, palette, now_playing};
...
fn render_import_progress(f: &mut Frame, area: Rect, import: &crate::state::app_state::SpotifyImportState) {
    ...
    let popup_area = palette::centered_rect(60, 25, area);
